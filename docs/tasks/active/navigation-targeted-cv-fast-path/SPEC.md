...
1. **Stage/Domain legacy main-card fallback audit.** Re-check whether any canonical normal-path reset-first alignment or horizontal search remains reachable. Preserve Stage sub-stage flow and Domain entry/start/explore. Compatibility/recovery paths are not automatically dead.
