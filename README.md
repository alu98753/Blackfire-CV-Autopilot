...
- **[已完成] 背包清理貴重裝備自動反選與稀有度自適應保留**
  - **色彩範圍特徵工程**：採用自適應 `120x120` 的「環狀區域遮罩」，排除最外圈發光選框與中心打勾圖示，提取裝備本質底色。
  - **獨立 HSV 品質防線**：為紫、藍、橘黃、紅等各品質顏色設置了專屬的飽和度 $S$ 與亮度 $V$ 閾值（如橘黃防線設為 $S \ge 100$、$V \ge 60$），既能 100% 辨識暗紫色與亮黃色貴重裝備，又完美過濾了灰色大石棒等低稀有度裝備的咖啡色干擾。
- **[待辦] 自動裝備一鍵穿戴與鎖定** (規劃中)
- **[待辦] 體力耗盡自動購買或領取郵箱禮包** (規劃中)
