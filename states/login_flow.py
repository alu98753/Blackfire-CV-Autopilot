...
def _wait_for_town(state_machine, rect):
    ...
    while time.time() - start_wait < 35.0:
        ...
        try:
            ...
            scene_info = detector.detect_scene(screen_img, machine=state_machine)
        ...
        # 備援特徵檢查 (涵蓋戰鬥 auto.png、結算 continue.png、地下城通關 dungeons_complete.png 等)
        if not ready_found:
            for ready_feature in [
                "common/door.png", "common/auto.png", "common/select_stage.png", "dungeons/dungeon.png",
                "dungeons/dungeons_complete.png", "dungeons/leave.png", "dungeons/dungeon_fight.png",
                "dungeons/gungeon_godown.png", "common/continue.png", "exit_battle.png", "goback_town.png"
            ]:
