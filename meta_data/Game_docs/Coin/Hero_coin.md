...
> 雖然底層數據寫入了 `character_decompose_rate: 0.125`（12.5% 返還），但遊戲作者在當前 PC/Steam 客戶端畫面上**並未實裝主動「英雄手動退役/直接出售英雄」按鈕**。不過在酒館抽卡時，**抽中已擁有的重複英雄會自動按 12.5% 比例折算返還英雄幣**（各品階機率與十連抽返還期望值詳見：[`TAVERN.md`](../Town_building/TAVERN.md)）。
...
* 消耗命運幣 (`fate_coin`) 轉動命運之輪，抽中英雄硬幣格單次給予 **`400` 或 `500` 英雄幣**。詳細獎池與機率分析可參見 [命運輪盤指南](../Town_building/FATE_WHEEL.md)。
...
## 🏆 五、全遊戲總英雄幣池與「三紅 ($12,800 \times 3 = 38,400$ 幣)」可行性驗證

> **結論核心**：遊戲作者在底層數值設計上剛好形成了**「全通必拿 3 隻頂級彩卡」**的精確閉環。集齊 3 隻頂級彩虹英雄（總計需 **`38,400 英雄幣`**）是 100% 完全可行且平滑的發育路線。

### 💰 總幣池兩大構成：

1. 💎 **全通一次性固定金礦**：**`37,700 幣`**
   * 🏆 **成就系統總里程碑** (2,000 點全滿)：**`21,000 幣`**
   * 🗺️ **主線 10 大章節滿星寶箱**：**`5,700 幣`**
   * 🏰 **10 大地下城首通寶箱**：**`5,500 幣`**
   * 📈 **帳號滿等 (Lv.100) 與經驗里程碑**：**`5,500 幣`**
2. 🔄 **日常穩定再生產出**：**`每月約 6,000 ~ 9,000 幣`**
   * 🌍 **遠征代幣兌換殘暉**：每日遠征產出，16 代幣換 1 殘暉（拆解得 25~75 幣），每天約 **+200 ~ 400 幣**。
   * 🎰 **每日免費抽英雄退幣**：每日免費 1 抽，重複退 12.5%，每天約 **+25 ~ 400 幣**（每月約 +1,800 幣）。
   * 📜 **酒館懸賞任務**：雕像 (500幣)、霜魂 (500幣)、魔法石 (200幣)，每週約 **+1,000 ~ 1,500 幣**。
   * 🎡 **命運之輪轉盤**：單次抽中英雄幣格給予 **+400 ~ 500 幣**。

---

## 🗺️ 六、第 1 隻到第 3 隻彩虹英雄獲取進程與關卡里程碑

```mermaid
graph LR
    A["【第 1 隻 德魯戈】<br>進度：主線第 6 章 / 地下城 6<br>累計約 1.5 萬幣<br>👉 現成直接全款購買！"] 
    -->|戰力破 2800 橫掃荒地與火山<br>耗時約 1~2 週| B["【第 2 隻 阿爾德里安】<br>進度：主線第 8 章 / 地下城 8 巨龍<br>累計約 2.8 萬幣<br>雙人類+被動復活成型！"]
    -->|通關深淵地獄與全滿星<br>耗時約 2~3 週| C["【第 3 隻 阿斯卡】<br>進度：主線第 10 章全滿星 / 滿成就<br>累計約 4.2 萬幣<br>🏆 終極三紅國家隊畢業！"]
```

### 📋 逐隻獲取進程明細表

| 目標進度 | 預計打到哪裡 (關卡與成就進度) | 幣數來源構成明細 | 累計總幣數 | 預計耗時與戰力質變 |
| :--- | :--- | :--- | :---: | :--- |
| **🥇 第 1 隻**<br>(12,800 幣)<br>👉 **德魯戈** | **【前期第 6 章結束】**<br>* 主線：通關前 6 章 (冰霜峽谷)<br>* 地下城：通關前 6 關 (冰霜洞窟)<br>* 帳號：Lv.35 + 成就約 1,000 點 | * 主線前 6 章：2,100<br>* 地下城前 6 關：2,100<br>* 成就 1,000 點：5,500<br>* 帳號升級與大世界：2,100<br>* 免費抽/懸賞/遠征：約 3,200 | **`約 15,000 幣`**<br>*(已達標)* | **【立刻購買】**<br>買入德魯戈後，戰力飆升衝破 2,800 門檻，物理單體處決傷害暴增 3 倍！ |
| **🥈 第 2 隻**<br>(累計 25,600 幣)<br>👉 **阿爾德里安** | **【中期第 8 章推進】**<br>* 主線：通關第 7 章(遺忘荒地) + 第 8 章(熾熱火山)<br>* 地下城：首通第 7 關(獸人掩體) + 第 8 關(巨龍之巢)<br>* 帳號：Lv.65 + 成就達到 1,400 點 | * 累積一次性獎勵：<br>  - 主線第 7~8 章 (+1,700)<br>  - 地下城第 7~8 關 (+1,500)<br>  - 成就衝至 1,400 點 (+5,000)<br>  - 帳號升級至 Lv.65 (+1,500)<br>* 2 週日常再生收益：約 3,500 | **`約 28,000 幣`**<br>*(足夠買第 2 隻)* | **【約 1 ~ 2 週】**<br>換入大主教阿爾德里安，獲得「全隊被動滿血復活」+「雙人類全屬性+10%」，高難本徹底零翻車。 |
| **🥉 第 3 隻**<br>(累計 38,400 幣)<br>👉 **阿斯卡** | **【大後期全通畢業】**<br>* 主線：全 10 章全滿星 (地獄之門)<br>* 地下城：全 10 關首通 (深淵地獄)<br>* 帳號：Lv.90~100 + 成就 1,800~2,000 點 | * 累積一次性獎勵：<br>  - 主線 9~10 章 (+1,900)<br>  - 地下城 9~10 關 (+1,900)<br>  - 成就達到 1,800 點 (+6,800)<br>  - 帳號滿等 (+1,750)<br>* 1 個月日常累積：約 6,000 | **`約 42,000 幣`**<br>*(綽綽有餘)* | **【再約 2 ~ 3 週】**<br>換入神聖裁決者阿斯卡，全隊免疫沉默、雙神聖破甲+物理核彈，全遊戲終極畢業！ |