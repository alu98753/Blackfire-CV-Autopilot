...
- 🏛️ **5 大 Clean Architecture 規範** ➔ [references/core_design_patterns.md](file:///e:/Side_Project/BlackfireCrusade_tool/.agents/skills/state_machine_development/references/core_design_patterns.md)
