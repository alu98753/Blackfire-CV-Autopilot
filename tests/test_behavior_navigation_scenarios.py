...
class TestNavigationScenarios(BehavioralScenarioTestCase):
    ...
    def test_stage_navigation_path_with_scrolling(self, mock_time, mock_exists):
        ...
        # 拖曳的點由視窗中心點與 NavigationHandler.SUB_STAGE_SCROLL_OFFSET_Y 決定
        from states.handlers.navigation import NavigationHandler
        offset_y = NavigationHandler.SUB_STAGE_SCROLL_OFFSET_Y
        self.mock_mouse.drag.assert_called_with(960, 540 + offset_y, 960, 540 - offset_y)
