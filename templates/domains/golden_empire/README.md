...
進入古國場景後，主流程持續尋找並點擊 `templates/domains/common/explore_btn.png`（每次消耗 3 麵包）。點擊後依底層事件分為三大分支：
...
* **特徵辨識**：辨識到挖寶畫面 (`templates/domains/common/find_treasure.png` 或 `templates/domains/common/treasure.png`)。
* **開箱決策**：
  * **僅點擊第 1 次免費開箱**。
...
| `templates/domains/common/explore_btn.png` | 領地主場景探索按鈕 (通用，消耗 3 麵包) | ✅ 已就緒 |
| `templates/domains/common/open.png` | 挖寶「打開」精確點擊按鈕 (通用免費開箱) | ✅ 已就緒 |
| `templates/domains/common/find_treasure.png` | 挖寶事件標題/視窗特徵圖 (通用) | ✅ 已就緒 |
| `templates/domains/common/treasure.png` | 寶箱/寶物卡片特徵圖 (通用) | ✅ 已就緒 |
...
| `templates/nemesis/domain/golden_empire/golden_king.png` | 古國強敵「黃金君王」遭遇特徵 | ✅ 已就緒 |
| `templates/nemesis/domain/golden_empire/elf_mythril_hag.png` | 古國強敵「精靈秘銀妖婆」遭遇特徵 | ✅ 已就緒 |
| `templates/nemesis/domain/golden_empire/undead_altalim.png` | 古國強敵「不死者阿爾塔林」遭遇特徵 | ✅ 已就緒 |
| `templates/nemesis/domain/golden_empire/human_golden_tulakh.png` | 古國強敵「黃金圖拉赫」遭遇特徵 | ✅ 已就緒 |
| `templates/nemesis/domain/golden_empire/golden_wall_guard_tulan.png` | 古國強敵「金壁守衛圖拉安」遭遇特徵 | ✅ 已就緒 |
